...
- This agent researches only public companies using SEC EDGAR's public filings and data. All information handled is already public disclosure.
- Every factual claim about a company should trace back to a specific filing (form type and filing date) retrieved during the session.
